...
from src.edge_match2 import EdgeMatch2
from src.create_data_list import create_data_list

def load_config(mode = None):
    parser = argparse.ArgumentParser()
    parser.add_argument("--path", "--checkpoints", type = str, default = "./checkpoints2", help = "model checkpoint path, default = ./checkpoints")
